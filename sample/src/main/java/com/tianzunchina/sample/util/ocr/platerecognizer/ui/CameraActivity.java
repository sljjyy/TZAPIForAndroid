package com.tianzunchina.sample.util.ocr.platerecognizer.ui;
...
import com.tianzunchina.sample.util.ocr.EasyPR.PlateRecognizer;
import com.tianzunchina.sample.util.ocr.platerecognizer.base.BaseActivity;
import com.tianzunchina.sample.util.ocr.util.BitmapUtil;
import com.tianzunchina.sample.util.ocr.util.FileUtil;
...
public class CameraActivity extends BaseActivity implements SurfaceHolder.Callback,View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        } else if (i1 == R.id.ivCapturePhoto) {// 拍照,设置相关参数
