...
JNIEXPORT jstring JNICALL Java_com_tianzunchina_sample_util_ocr_EasyPR_PlateRecognizer_stringFromJNI(JNIEnv *env, jclass instance) {
...
JNIEXPORT jlong JNICALL Java_com_tianzunchina_sample_util_ocr_EasyPR_PlateRecognizer_initPR(JNIEnv *env, jclass instance, jstring svmpath, jstring annpath) {
...
JNIEXPORT jlong JNICALL Java_com_tianzunchina_sample_util_ocr_EasyPR_PlateRecognizer_uninitPR(JNIEnv *env, jclass instance, jlong recognizerPtr) {
...
JNIEXPORT jbyteArray JNICALL Java_com_tianzunchina_sample_util_ocr_EasyPR_PlateRecognizer_plateRecognize(JNIEnv *env, jclass instance, jlong recognizerPtr, jstring imgpath) {
    CPlateRecognize *pr = (CPlateRecognize *)recognizerPtr;
