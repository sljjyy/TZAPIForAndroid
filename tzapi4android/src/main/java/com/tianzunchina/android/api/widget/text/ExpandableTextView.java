package com.tianzunchina.android.api.widget.text;
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = getDrawable(getContext(), R.drawable.ic_expandable_more);
        }
        if (mCollapseDrawable == null) {
            mCollapseDrawable = getDrawable(getContext(), R.drawable.ic_expandable_less);
        }
    ...
    private void findViews() {
        mTv = (TextView) findViewById(R.id.tvExpandable);
        mTv.setTextColor(mContentTextColor);
        mTv.setTextSize(mContentTextSize);
        mTv.setOnClickListener(this);

        mStateTv = (TextView) findViewById(R.id.tvExpandCollapse);
